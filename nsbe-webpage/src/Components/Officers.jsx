  ...
  export default function Officers() {
    return (
      ...
      <div className="purple-bg py-24 sm:py-16">
        <h1 className="mx-auto max-w-7xl px-6 lg:px-8 text-3xl mb-10 subheaderstyle text-gray-900 sm:text-7xl">{chairperson.role.zone}</h1>
        <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
          <div className="max-w-5xl w-96 mx-auto lg:max-w-none">
            <div className="darkbg">
              <img className="rounded-2xl object-cover object-center items-center justify-center w-full h-60 " src={chairperson.imageUrl} alt="" />
            </div>
