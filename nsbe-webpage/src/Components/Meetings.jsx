    ...
    <div className="bg-white py-16 sm:py-16">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-5 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          <h3 className="text-base font-semibold leading-7 text-gray-900 border-l-8 border-green-800 px-3">Upcoming Socials</h3>
        </div>
          ...
          {socials.map((post) => (
            <article key={post.id} className="flex max-w-xl flex-col items-start justify-between">
              <div className="relative w-full items-center gap-y-5 lg:flex my-4 ">
                <img className="rounded-2xl" src={post.slideImg} alt="" />
              </div>
        ...
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="mt-32 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Recent Events</h2>
          <p className="mt-2 text-lg leading-8 text-gray-600 border-b border-gray-200 mx-auto pb-5">
            Check out any events or opportunities you may have missed.
          </p>
        </div>
        <div className="mx-auto mt-5 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          <h3 className="text-base font-semibold leading-7 text-gray-900 border-l-8 border-green-800 px-3">General Body Meetings</h3>
        </div>
        <div className="mx-auto mt-2 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 pt-10 sm:mt-2 sm:pt-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {gbmposts.map((post) => (
            <article key={post.id} className="flex max-w-xl flex-col items-start justify-between">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          <h3 className="text-base font-semibold leading-7 text-gray-900 border-l-8 border-x-green-800 px-3">Freshman Action Team Meetings</h3>
        </div>
        <div className="mx-auto mt-2 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 pt-10 sm:mt-2 sm:pt-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {fatposts.map((post) => (
            <article key={post.id} className="flex max-w-xl flex-col items-start justify-between">
