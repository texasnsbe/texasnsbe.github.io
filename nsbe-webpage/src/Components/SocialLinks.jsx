    ...
    return (
      <div className="purple-bg py-40">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="flex flex-row justify-around mx-auto mt-10 max-w-lg items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
